...
listenompokemon=['Bulbizarre','Herbizarre','Florizarre','Salamèche','Reptincel','Dracaufeu','Carapuce','Carabaffe','Tortank','Chenipan','Chrysacier','Papillusion','Aspicot','Coconfort','Dardagnan','Roucool','Roucoups','Roucarnage','Rattata','Rattatac','Piafabec','Rapasdepic','Abo','Arbok','Pikachu','Raichu','Ptéra','Magicarpe','Léviator','Évoli','Aquali','Voltali','Pyroli','Kabuto','Kabutops','Artikodin','Électhor','Sulfura','Mewtwo','Germignon','Macronium','Méganium','Héricendre','Feurisson','Typhlosion','Kaiminus','Crocrodil','Aligatueur','Mentali','Noctali','Lugia','Ho-Oh']
