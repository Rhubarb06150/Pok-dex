...
listepokemon.append(Pokemon(19,['ratata','rattata'],'Rattata',30,56,35,72,25,25,35,False,['Rattatac'],False,False,20,False,False,False,['Route 1','Route2','Route 4','Route 9','Route 16','Route 21','Route 22'

listepokemon.append(Pokemon(131,['lokhlass'],'Lokhlass',130,85,80,60,95,85,95,False,False,False,False,False,False,False,False,['Offert par un employé de la Sylphe SARL à Safrania après avoir battu le Rival'],['Offert par un employé de la Sylphe SARL à Safrania après avoir battu le Rival'],['Offert par un employé de la Sylphe SARL à Safrania après avoir battu le Rival'],['Caves Jumelles (second sous-sol, le vendredi uniquement'],['Caves Jumelles (second sous-sol, le vendredi uniquement'],['Caves Jumelles (second sous-sol, le vendredi uniquement'],'Eau','Glace',9945,50,50,45,['Combat','Électrik','Plante','Roche'],False,['Eau'],['Glace'],False))
